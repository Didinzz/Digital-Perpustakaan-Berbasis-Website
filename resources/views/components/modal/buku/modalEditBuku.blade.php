...
<div id="edit-modal-{{ $buku->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="edit-modal-{{ $buku->id }}">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlahBuku" id="jumlahBuku"
                            value="{{ old('jumlahBuku', $buku->jumlah_buku) }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="deskripsi" rows="4"
                            ...
                            placeholder="Deskripsi Buku" name="deskripsi" required> {{ old('deskripsi', $buku->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
