@props(['kategori'])
<!-- Add Kategori Modal -->
<div id="edit-kategori-modal-{{ $kategori->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="edit-kategori-modal-{{ $kategori->id }}">
            ...
            <form action="{{ route('dashboard.kategori.update', $kategori->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="kategori_name" name="kategori"
                        value="{{ old('kategori', $kategori->kategori_buku) }}"
